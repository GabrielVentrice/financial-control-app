export interface Transaction {
  ...
  /**
   * True for installment rows generated by the projection (#2..N of a series).
   * These are a forecast, not something that already happened — see
   * shared/installments.ts.
   */
  projected?: boolean
}
